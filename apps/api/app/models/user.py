"""Existing tables – users, chickens, orders, nft_ownership."""
import uuid
...
class User(Base, TimestampMixin):
    ...
    # relationships to new game tables
    game_wallet: Mapped["GameWallet"] = relationship(back_populates="user", uselist=False)  # type: ignore[name-defined]
